...
const Datenschutz = () =>
{
    return (
        <div className="legal-content">
            ...
            <p>Damian Groß Hiltenspergerstr. 45, 90796 München Germany</p>
            ...
            <p>Datenverarbeitung in Drittländern: Sofern wir Daten in einem Drittland (d. h., außerhalb der Europäischen Union (EU),
                ...
                Handelsministeriums der USA unter <a href="https://www.dataprivacyframework.gov/"
                    target="_blank">https://www.dataprivacyframework.gov/</a> (in Englisch) entnehmen. Wir informieren Sie im Rahmen
